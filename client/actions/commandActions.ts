...
export const setCurrentCommand = (command: string, cursorIndex: number): CommandSetCurrent => ({
  payload: {
    command,
    cursorIndex,
  },
...
export const selectAutocompleteItem = (item: AutocompleteItem): CommandSelectAutocompleteItem => ({
  payload: {
    item,
  },
  type: 'COMMAND_SELECT_AUTOCOMPLETE_ITEM',
